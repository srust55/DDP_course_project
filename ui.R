shinyUI(
    pageWithSidebar(
        ...
        headerPanel("Predicting Alzheimer Disease"),
        ...
        mainPanel(
            ...
            h3("DOCUMENTATION"),
                ...
                h4('Results'),
                    ...
                    h5('of a proportion.'),
                h4('Notes'),
                    h5('A. This application performs best with the Firefox browser'),
                    h5('B. When entering input values as text, limits on input values are not enforced')
        )
    )
)
